...
const RagPage: React.FC = () => {
  ...
  const onSend = useCallback(() => {
    postMessage(content, getModel(modelName));
    setContent('');
  }, [modelName, content, postMessage, setContent, getModel]);
  ...
  return (
    <>
      <div className={`${!isEmpty ? 'screen:pb-36' : ''}`}>
        ...
        {isEmpty && (
          <div className="absolute inset-x-0 top-32 m-auto flex justify-center">
            <Alert severity="info">
              <div>
