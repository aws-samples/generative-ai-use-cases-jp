...
import { PiBookOpenText, PiFlask, PiSpinnerGap, PiTrash } from 'react-icons/pi';
    ...
    return (
      <li
        className={
          props.className
            ? props.className
            : 'my-2 cursor-pointer hover:underline'
        }
