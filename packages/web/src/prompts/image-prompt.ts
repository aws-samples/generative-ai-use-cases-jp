...
# ルール
* プロンプトは「# プロンプトのフォーマット」の通りに、JSON形式で出力してください。JSON以外の文字列は一切出力しないでください。「申し訳ございません」などの雑談は一切不要です。例外はありません。
...
* 画像に含めたくない要素については、negativePromptとして出力してください。
