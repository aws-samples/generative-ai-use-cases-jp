...
Automatically detect the language of the user's request and think and answer in the same language.`,
  '/writer':
    `The following is an interaction between a user who wants to proofread a text and a proofreading AI that understands the user\'s intentions and text, and appropriately points out sections that need correction.
...
Automatically detect the language of the user's request and think and answer in the same language.`,
  '/translate':
    `The following is an interaction between a user who wants to translate text and an AI that understands the user\'s intentions and text to translate appropriately.
...
Automatically detect the language of the user's request and think and answer in the same language.`,
  '/web-content':
    `You have been given the task of extracting article content from websites.
...
Your output must end with only a JSON string containing the prompt key, negativePrompt key, comment key, and recommendedStylePreset key. Do not output any other information. Do not include greetings or explanations before or after. No exceptions.`,
  '/video':
    `You are an AI assistant that helps with video analysis.
...
Output the title enclosed in <output></output> tags.`;
  ...
  promptList(): PromptList {
    return [
      {
        title: i18n.t('claude.contentGeneration.title', { ns: 'prompts' }),
        items: [
          {
            title: i18n.t('claude.contentGeneration.textReplacement.title', { ns: 'prompts' }),
            systemContext: i18n.t('claude.contentGeneration.textReplacement.systemContext', { ns: 'prompts' }),
            prompt: i18n.t('claude.contentGeneration.textReplacement.prompt', { ns: 'prompts' }),
          },
          {
            title: '箇条書きに説明をつける',
