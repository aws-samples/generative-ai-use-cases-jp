...
ただし、出力は要約内容を <output></output> の xml タグで囲われたものだけを出力してください。例外はありません。
`
}
`;
  },
...
${context ? 'ただし、修正案や指摘は以下の <その他指摘してほしいこと></その他指摘してほしいこと>の xml タグで囲われたことを考慮してください。 <その他指摘してほしいこと>' + context + '</その他指摘してほしいこと>' : ''}
...
${!context ? '' : `ただし、翻訳時に<考慮して欲しいこと></考慮して欲しいこと> の xml タグで囲われた内容を考慮してください。<考慮して欲しいこと>${context}</考慮して欲しいこと>`}
