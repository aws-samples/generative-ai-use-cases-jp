...
const { textModels, filterTextModels, filterImageGenModels } = MODELS;
...
export const summarizePrompt = {
  supportedModels: filterTextModels([
    'anthropic.claude-v2',
...
export const imageInput = {
  supportedModels: filterImageGenModels([
